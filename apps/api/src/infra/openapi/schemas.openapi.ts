...
export const openApiSchemas: Record<string, OpenApiSchema> = {
  ...
  ProjectExecutionMode: {
    type: 'string',
    enum: ['GITHUB_ACTIONS', 'LOCAL_AGENT', 'MANUAL'],
  },
  Project: {
    type: 'object',
    ...
    properties: {
      ...
      executionMode: { $ref: '#/components/schemas/ProjectExecutionMode' },
  ...
  GitHubRepositoryOption: {
    ...
    properties: {
      id: { type: 'string' },
      name: { type: 'string' },
      fullName: { type: 'string', example: 'acme/checkout' },
  ...
  GitHubRepositoryList: {
    type: 'array',
    items: { $ref: '#/components/schemas/GitHubRepositoryOption' },
  },
  WorkspaceDashboard: {
    type: 'object',
