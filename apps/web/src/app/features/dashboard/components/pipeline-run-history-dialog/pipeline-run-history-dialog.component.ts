...
import { lucideCircleStop, lucideClock3, lucideGitBranch, lucideX } from '@ng-icons/lucide';
...
@Component({
  ...
  imports: [NgIcon],
  providers: [provideIcons({ lucideCircleStop, lucideClock3, lucideGitBranch, lucideX })],
